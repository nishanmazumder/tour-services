...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/index.dwt" codeOutsideHTMLIsLocked="false" -->
	...
	<head>
		...
		<title>Contacter Taxi Courchevel Transfert</title>
						...
						<div class="container">
							<div class="row">
								...
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<h3>Taxi Courchevel transferts </h3>
									<h4>  438 avenue de Savoie  <br />
									  73260 AIGUEBLANCHE<br />
									</h4>
									<h3><span class="petit">Contact direct</span> : <br />
									Tel : +33(0)6-52-79-38-73</h3>
									<p><a href="mailto:contact@taxicourcheveltransferts.com">contact@courcheveltransferts.com </a></p>
									<div class="mentions">
										<p>Vous disposez d&rsquo;un droit d&rsquo;acc&egrave;s, de modification, de rectification et de   suppression des donn&eacute;es vous concernant (loi &laquo; Informatique et Libert&eacute;s &raquo; du 6   janvier 1978). Pour toute demande, adressez-vous &agrave; Taxi Courchevel Transfert. Les informations recueillies &agrave; travers notre   formulaire ne seront pas transmises &agrave; des soci&eacute;t&eacute;s tiers.</p>
									</div>
									<!-- InstanceEndEditable --> 
								</div>
								...
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<div id="contact-form">
										...
										<h3 class="envoye">Votre message a bien &eacute;t&eacute; envoy&eacute; !</h3>
										<h5><a href="contact.php" target="_self">Envoyer un autre message&gt;</a></h5>
										<? } else { ?>
										...
										<form enctype="multipart/form-data" name="formulaire" action="javascript:check_newsletter()" method="post" accept-charset="UTF-8">
											...
											<table id="contacttableau" border="0" cellpadding="0" cellspacing="0">
												<tbody>
													<tr>
														<td><b>Nom-pr&eacute;nom<span class="gras-rouge">*</span></b></td>
														<td><input name="cont_nom" id="cont_nom" maxlength="100" type="text" /></td>
													</tr>
													<tr>
														<td><b>Pays</b></td>
														<td><input name="cont_adresse" type="text" id="cont_adresse" value="" /></td>
													</tr>
													<tr>
														<td><b>T&eacute;l&eacute;phone portable</b></td>
														<td><input name="cont_tel" id="cont_tel" maxlength="100" type="text" /></td>
													</tr>
													<tr>
														<td><b>Email<span class="gras-rouge">*</span></b></td>
														<td><input name="cont_email" id="cont_email" maxlength="100" type="text" onchange="checkEmail(this.value)" /></td>
													</tr>
													<tr>
													...
													<tr>
														<td class="petit"><span class="gras-rouge">*</span> Champs obligatoires</td>
														<td class="envoyer"><label>
																<input class="submit_button_contact" type="submit" name="Submit" value="Envoyer votre message" />
															</label>
														</td>
													</tr>
												</tbody>
