...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/index.dwt" codeOutsideHTMLIsLocked="false" -->
	...
	<head>
		...
		<title>Taxi Courchevel costs and prices in Savoie</title>
		<meta name="description" content="Taxi to Courchevel, prices of transportations, taxi in Savoie to ski resorts of courchevel in Haute Tarentaise." />
					...
					<div class="int"> <!-- InstanceBeginEditable name="EditRegionContenu" -->
						<div class="container">
							<div class="row">
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<h1>Rates</h1>
									<h2>ALL PRICES QUOTED ARE FOR MOUTIERS STATION PICK UPS</h2>
									<h4>PLEASE<a href="http://www.taximoutierstransfert.com/admin/contact.php"> CONTACT US</a> FOR PRICES CONCERNING ALL OTHER DESTINATIONS OR PICK UP POINTS.<br />
									<br />
									<em>PRICES GIVEN ARE FOR REFERENCE ONLY, PASSENGERS WILL BE EXPECTED TO PAY THE FULL FARE  DISPLAYED ON THE METER AT THE END OF THE JOURNEY.</em></h4>
									<p>&nbsp;</p>
								</div>
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
