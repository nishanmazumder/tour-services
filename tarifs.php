...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/index.dwt" codeOutsideHTMLIsLocked="false" -->
	...
	<head>
		...
		<title>Taxi Courchevel tarifs Taxi Moutiers Transfert les 3 Vall&eacute;es en Savoie</title>
		<meta name="description" content="Taxi Courchevel, tarifs transport et taxi en Savoie vers les stations de courchevel, méribel, les menuires, val thorens, st Martin Belleville, plagne, les arcs, tignes, val d'isere... Taxi vip et transport de groupes vers les stations de ski de Tarentaise : Les 3 Vallées et Haute Tarentaise." />
		<meta name="keywords" content="tarif,tarifs,prix,forfait,course,taxi,taxis,courchevel,moutiers,lyon,albertville,grenoble,geneve,groupes,groupes,destination,la plagne,les arcs,tignes,val d'isere,valmorel,val thorens," />
					...
					<div class="int"> <!-- InstanceBeginEditable name="EditRegionContenu" -->
						<div class="container">
							<div class="row">
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<h1>Nos Tarifs</h1>
									<h2>Tarifs depuis la gare de Mo&ucirc;tiers</h2>
									<h4>Pour toute autre destination ou lieu de prise en charge,&nbsp;<a data-cke-saved-href="contact.php" href="contact.php">nous contacter</a><br />
								</div>
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									 <em>Tarifs &agrave; titre indicatif, seul le tarif affich&eacute; au compteur taxim&egrave;tre &agrave; la d&eacute;pose compte.</em></h4>

									<?php include("admin/data/blocks/tarifs-depart-moutiers.html"); ?>
									<?php include("admin/data/blocks/aeroports.html"); ?>
								</div>
							</div>
						</div>
					</div>
