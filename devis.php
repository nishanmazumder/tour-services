...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/index.dwt" codeOutsideHTMLIsLocked="false" -->
	...
	<title>Reservation de taxi destination Courchevel</title>
	<meta name="description" content="Devis Taxi en Savoie, demande de reservation pour un taxi vers ou depuis courchevel en Savoie" />
...
<style type="text/css">
<!--
#menu ul li.reservation a { background-color: #FFFFFF; }
.contacttableau td {
	padding: 2px 15px;
	margin: 0px;
	font-size: 0.9em;
					  ...
					  <div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav mr-auto">
						  <li class="nav-item active">
							<a href="index.html" target="_self" class="btn1 nav-link"><span>Accueil</span></a>
						  </li>
						  <li class="nav-item">
							<a href="prestations.html" target="_self" class="btn2 nav-link"><span>Nos prestations</span></a>
						  </li>
						  <li class="nav-item">
							<a href="devis.php" target="_self" class="btn3 nav-link"><span>Devis réservations</span></a>
						  </li>
						  <li class="nav-item">
							<a href="tarifs.php" target="_self" class="btn4 nav-link"><span>Nos tarifs</span></a>
						  </li>
						  <li class="nav-item">
							<a href="contact.php" target="_self" class="btn5 nav-link"><span>Contact</span></a>
						  </li>
						</ul>
					  </div>
					</nav>
				...
				<div class="row no-gutters">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ul class="language_bar">
						  ...
						  <li><a href="en/index.html" target="_self" class="btn2"><span>English</span></a></li>
						</ul>
					</div>
				</div>
			</div>
						...
						<div class="container">
							<div class="row">
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									...
									<h2>Votre demande de devis a bien &eacute;t&eacute; envoy&eacute;e !</h2>
									<p><a href="devis.php" target="_self">Envoyer une autre demande de devis &gt;</a></p>
									<? } else { ?>
									<h1>Devis / R&eacute;servations</h1>
									<div class="clr"></div>
								</div>
								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									<h2 class="telephone_space">T&eacute;l&eacute;phone bureau <br />
											Tel : +33(0)6-52-79-38-73</h2>
								</div>
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<form action="javascript:check_newsletter()" method="post" enctype="multipart/form-data" name="formulaire" id="formulaire">
										...
										<table class="contacttableau" border="0" cellpadding="0" cellspacing="0">
											<tbody>
												<tr>
													<td class="aligndroite"><strong>Civilit&eacute; :</strong></td>
												...
												<tr>
													<td class="aligndroite"><strong><span class="gras-rouge">*</span>Nom  : </strong></td>
													<td><input name="cont_nom" id="cont_nom" size="30" maxlength="100" type="text" /></td>
												</tr>							
												<tr>
													<td class="aligndroite"><strong>Pr&eacute;nom :</strong></td>
													<td><input name="cont_prenom" id="cont_prenom" size="30" maxlength="100" type="text" /></td>
												</tr>
												<tr>
													<td class="aligndroite"><strong><span class="gras-rouge">*</span>T&eacute;l&eacute;phone :</strong></td>
													<td><input name="cont_tel" id="cont_tel" size="30" maxlength="100" type="text" /></td>
												</tr>
												<tr>
													<td class="aligndroite"><strong><span class="gras-rouge">*</span>Email :</strong></td>
												...
												<tr>
													<td class="aligndroite"><strong><span class="gras-rouge">*</span>Au d&eacute;part de   :</strong></td>
													<td><input name="cont_aller_depart" id="cont_aller_depart" size="30" maxlength="200" type="text" /></td>
												</tr>
												<tr>
													<td class="aligndroite"><strong><span class="gras-rouge">*</span>A Destination de :</strong></td>
												...
												<tr>
													<td class="aligndroite"><strong><span class="gras-rouge">*</span>Heure de d&eacute;part :</strong></td>
												...
												<tr>
													<td class="aligndroite"><strong><span class="gras-rouge">*</span>Nombre de passagers&nbsp; :</strong></td>
													<td><strong>
														<input name="cont_aller_passagers" type="text" id="cont_aller_passagers" size="4" />
														</strong></td>
												</tr>
												<tr>
													<td class="aligndroite"><strong>Nombre Si&egrave;ges b&eacute;b&eacute; :</strong></td>
													<td><input name="cont_aller_sieges_bebe" type="text" id="cont_aller_sieges_bebe" size="4" /></td>
												</tr>
												<tr>
													<td class="aligndroite"><strong>Nbre R&eacute;hausseurs :</strong></td>
													<td><strong>
														<input name="cont_aller_rehausseur" type="text" id="cont_aller_rehausseur" size="4" />
														</strong></td>
												</tr>
												<tr>
												  <td class="aligndroite"><b>Nbre Bagages volumineux :</b></td>
												  <td><strong>
													<input name="cont_aller_bagage_volum" type="text" id="cont_aller_bagage_volum" size="4" />
												  </strong></td>
											  </tr>
												<tr>
													<td class="aligndroite"><strong>Nbre de skis ou surfs :</strong></td>
												...
												<tr>
													<td colspan="2" class="envoyer"><input name="Submit" type="submit" class="gras-rouge submit_button_devis" value="Envoyer votre demande" /> </td>
												</tr>
											</tbody>
										</table>
									</form>
